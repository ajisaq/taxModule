...
def add_business(request):
	...
	return render(request, "forms/add_business.html", {'locations':location, 'business':business, 'business_category':business_category, 'edit':edit, 'bd_cr':bd_cr})
...
def add_location(request):
	...
	return render(request, "forms/add_location.html", {'location':location, 'edit':edit, 'bd_cr':bd_cr})
...
def add_supervisor(request):
	...
	return render(request, "forms/add_supervisor.html", {'supervisor':supervisor, 'locations':loc, 'edit':edit, 'bd_cr':bd_cr})

def add_admin(request):
	business = Business.objects.all()
	bd_cr=[{'name':'Supervisor','url':'/supervisor/'},{'name':'Add', 'url':''}]
	return render(request, "forms/add_administrator.html", {'businesses':business})
...
def add_category(request):
	...
	return render(request, "forms/add_category.html", {'category':category, 'edit':edit, 'bd_cr':bd_cr})
...
def location(request):
	...
	return render(request, "location.html", {'locations':locations, 'bd_cr':bd_cr})

def supervisor(request):
	supervisors = Profile.objects.filter(is_supervisor=True)
	bd_cr=[{'name':'Supervisors','url':'/supervisor/'}]
	return render(request, "supervisor.html", {'supervisors':supervisors, 'bd_cr':bd_cr})

def business_category(request):
	categories = Business_Category.objects.all()
	bd_cr=[{'name':'Category','url':'/business/category/'}]
	return render(request, "business_category.html", {'categories':categories, 'bd_cr':bd_cr})

def business(request):
	business = Business.objects.all()
	bd_cr=[{'name':'Businesses','url':'/business/'}]
	return render(request, "business.html", {'businesses':business, 'bd_cr':bd_cr})

def administrator(request):
	business = Business.objects.all()
	bd_cr=[{'name':'Administrator','url':'/administrator/'}]
	return render(request, "administrator.html", {'businesses':business, 'bd_cr':bd_cr})